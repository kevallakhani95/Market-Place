...
if(isset($_POST['btn_login']))                                 
  {
    ...
    $sqlquery=$conn->query("select cname from customer where cname='$uname'");   
	...
	<div class = "container">
		<div class="wrapper">
			<form method="post" name="Login_Form" class="form-signin">       
			    <h3 class="form-signin-heading">Welcome to Click 'n' Shop!</h3>
				  <hr class="colorgraph"><br>
				  
				  <input type="text" class="form-control" name="username" placeholder="Username" required="" autofocus="" />
				  <input type="text" class="form-control" name="keyword" placeholder="Search me" />     		  
				 <br>
